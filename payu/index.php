    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm" >
      ...
      <input type="hidden" name="txnid" value="<?php echo $txnid ?>" />
	    ...
	    <input type="hidden" name="surl" value="http://localhost/payu/response.php" />   <!--Please change this parameter value with your success page absolute url like http://mywebsite.com/response.php. -->
		 <input type="hidden" name="furl" value="http://localhost/payu/response-fail.php" /><!--Please change this parameter value with your failure page absolute url like http://mywebsite.com/response.php. -->
